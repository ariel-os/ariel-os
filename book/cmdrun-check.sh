...
grep -qroP '(?s)<!--\s*cmdrun\s+(?!(\.\./\.\./doc/gen_book\.rs matrix \.\./\.\./doc/support_matrix\.yml /dev/stdout --tier [123] --template-path \.\./templates/support-matrix\.html\.tmpl|\.\./\.\./\.\./doc/gen_book\.rs board-list \.\./\.\./\.\./doc/support_matrix\.yml /dev/stdout --tier [123])\s*-->).*?-->' src/
res=$?
...
test "$(grep -roP '<!--\s*cmdrun\s+\.\./\.\./doc/gen_book\.rs matrix \.\./\.\./doc/support_matrix\.yml /dev/stdout --tier [123] --template-path \.\./templates/support-matrix\.html\.tmpl\s*-->' src/ | wc -l)" -eq 3
