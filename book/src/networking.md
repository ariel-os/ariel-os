...
To do that, the `network-config-override` [laze module](./build-system.md#laze-modules) needs to be enabled, and the [`#[ariel_os::config]` attribute macro][config-attr-macro-rustdoc] can be used to set the configuration.
