...
|Device Identity|<span title="not available on this piece of hardware">–</span>[^this-chip-does-not-feature-a-factory-written-unique-id]|
...
[^this-chip-does-not-feature-a-factory-written-unique-id]: This chip does not feature a factory-written unique ID.