...
<table class="support-matrix">
  ...
  <tbody>
	<tbody class="odd">
      <tr>
	    <td rowspan="2"><a href="../boards/espressif-esp32-c5-devkitc-1.html">Espressif ESP32-C5-DevKitC-1</a></td>
	  </tr>
	  <tr>
	    <td><code>espressif-esp32-c5-devkitc-1-n4</code></td>
