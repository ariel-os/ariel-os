...
|Bluetooth Low Energy|<span title="supported with some caveats">☑️</span>[^only-available-from-the-network-core]|
...
[^only-available-from-the-network-core]: Only available from the network core.
