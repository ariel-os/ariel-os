...
use ariel_os_sensors::sensor::{ReadingError, ReadingResult, Samples, State};
use ariel_os_sensors::{
    Category, Label, MeasurementUnit, Sensor,
    sensor::{Accuracy, ReadingChannel, ReadingChannels, ReadingWaiter, Sample},
};
...
impl Nrf91Gnss {
    ...
    pub async fn init(&self, _spawner: Spawner, config: config::Config) {
