...
#[cfg(all(context = "nrf52", feature = "ble-peripheral", not(feature = "ble-central")))]
const SDC_MEM_SIZE: usize = 2880;
#[cfg(all(context = "nrf52", feature = "ble-central", not(feature = "ble-peripheral")))]
...
#[cfg(all(context = "nrf53", feature = "ble-peripheral", not(feature = "ble-central")))]
const SDC_MEM_SIZE: usize = 4768;
#[cfg(all(context = "nrf53", feature = "ble-central", not(feature = "ble-peripheral")))]
