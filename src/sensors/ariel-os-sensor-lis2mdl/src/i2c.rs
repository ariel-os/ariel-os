...
ariel_os_hal::define_peripherals!(Peripherals {});
...
impl<I2C: I2c + Send> Lis2mdl<I2C> {
    ...
    async fn reset(i2c_device: &mut I2C) -> Result<(), ()> {
        ...
        // A configuration setting could be later added to control this.

        Ok(())
    }

    // FIXME: accuracy calculation
