...
// In the absence of clear link to the datasheet, timing information are sourced from the Tables 4 and 5
...
/// Maximal wait time in ms for a Medium Repeatbility measurement when powered with 2.4 < V < 5.5.
#[allow(dead_code)]
